        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="flex border-b">
              <button 
                className={`flex-1 px-4 py-2 text-center ${activeTab === 'requests' ? 'border-b-2 border-blue-500 font-medium' : 'text-gray-500 hover:text-gray-700'}`}
                onClick={() => setActiveTab('requests')}
              >
                Requests
              </button>
              <button 
                className={`flex-1 px-4 py-2 text-center ${activeTab === 'completed' ? 'border-b-2 border-blue-500 font-medium' : 'text-gray-500 hover:text-gray-700'}`}
                onClick={() => setActiveTab('completed')}
              >
                Completed
              </button>
              <button 
                className={`flex-1 px-4 py-2 text-center ${activeTab === 'feedback' ? 'border-b-2 border-blue-500 font-medium' : 'text-gray-500 hover:text-gray-700'}`}
