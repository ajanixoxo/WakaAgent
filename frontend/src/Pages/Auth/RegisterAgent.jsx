                    ...
                    <form onSubmit={handleSignUp} method="POST" className="space-y-6 p-2 w-[90%] md:w-[60%]">
                        <div className="flex flex-col md:flex-row gap-10 w-full">
                            ...
                            <div className="w-full">
                                ...
                                {/* <div>
                            <label htmlFor="country" className="block text-sm font-medium leading-6 p-2 text-gray-900">
                              Operationtal Base(Maximum of Three)
                            </label>
                            <div className="mt-2">
                              <input type="place" placeholder='Street, LGA, City & State' name="place1"
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-6 p-200 sm:text-sm sm:leading-6 p-2"
                                    />
                              <input type="place" placeholder='Street, LGA, City & State' name="place2"
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-6 p-200 sm:text-sm sm:leading-6 p-2"
                                    />
                              <input type="place" placeholder='Street, LGA, City & State' name="place3"
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-6 p-200 sm:text-sm sm:leading-6 p-2"
                               />
                            </div>
                        </div> */}
                                ...
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-sm">
                                            {/* <a href="#" className="font-semibold text-indigo-6 p-200 hover:text-indigo-500">
                    Forgot password?
                  </a> */}
                                        </div>
                                    </div>
                        ...
                        <div className="">
                            <button
                                type="submit"
                                className="flex w-1/2 mx-auto bg-blue-500 justify-center rounded-md bg-indigo-6 p-200 px-3 py-1.5 text-sm font-semibold leading-6 p-2 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-6 p-200"
                                disabled={isLoading}
                            >
